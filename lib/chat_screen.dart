...
import 'package:my_chat/text_compose.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<FirebaseUser> _gutUser() async {
  ...
  void _sendMenssage({String text, File imgfile}) async {
    final FirebaseUser user = await _gutUser();

    if (user == null) {
      _scaffoldKey.currentState.showSnackBar(SnackBar(
        content: Text(
            'Não foi possivel foi Possivel Fazer o login, Tente novamente!'),
